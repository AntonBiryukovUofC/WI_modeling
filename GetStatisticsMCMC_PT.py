...
with open( "samplerMCMC_PT_emcee.p", 'rb') as f:
...
models=model_file[0]
FinalIter = models.shape[0]
LL=model_file[3][0,...].flatten()
model_file_npz = np.load('models_PCA.npz')
...
ax3.invert_yaxis()
fig2.savefig('VelProfileMCMC_PT.png',dpi=300)
#ax2.autoscale()
# Plot the chain elements history
fig4,ax4 = plt.subplots(figsize = (8,6))
ModelsDF.plot(ax=ax4,subplots=True)
fig4.savefig('TimeHistoryChain_PT.png')
