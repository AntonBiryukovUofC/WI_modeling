...
Observations10Class = np.genfromtxt("./10Class/Observations.csv",dtype = float,defaultfmt = "%.3e",delimiter = ',')
ClassLabels10Class  = np.genfromtxt("./10Class/ClassLabels.csv",dtype = float,defaultfmt = "%d",delimiter = ',')
# delete non-midpoint classes:

bool_array = np.logical_not(np.in1d(ClassLabels10Class, (2,7)))
#raerasedr
OrigLab = ClassLabels10Class
Observations10Class = Observations10Class[bool_array,:]
ClassLabels10Class = ClassLabels10Class[bool_array]

ClassLabels10Class[np.in1d(ClassLabels10Class, (0,1))] = 0
ClassLabels10Class[np.in1d(ClassLabels10Class, (3,4))] = 1
ClassLabels10Class[np.in1d(ClassLabels10Class, (5,6))] = 2
ClassLabels10Class[np.in1d(ClassLabels10Class, (8,9))] = 3

# Predict on 10 class:
Predicted10Class = EQfit.predict(Observations10Class)
Accuracy10Class  = metrics.accuracy_score(ClassLabels10Class, Predicted10Class)
